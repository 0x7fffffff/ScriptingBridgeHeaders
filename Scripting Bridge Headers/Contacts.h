...
// A document.
@interface ContactsDocument : SBObject
...
// A window.
@interface ContactsWindow : SBObject
...
@interface ContactsAddress : SBObject
...
@interface ContactsContactInfo : SBObject
...
@interface ContactsEntry : SBObject
...
@interface ContactsSocialProfile : SBObject
