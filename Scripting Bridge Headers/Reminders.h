...
// A document.
@interface RemindersDocument : SBObject
...
// A window.
@interface RemindersWindow : SBObject
...
@interface RemindersAccount : SBObject
...
@interface RemindersList : SBObject
...
@interface RemindersReminder : SBObject
